...
//	@title			Dauction Auction-Dutch Service
//	@version		1.0
//	@description	The live descending-price (Dutch) auction engine: reservation deposits, full locks, server-authoritative price, and the hammer.
